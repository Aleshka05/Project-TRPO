...
void game() {
	...
	while (true) {
		...
		case 1:
			...
			countTry--;
			cout << "Введите число, которое, на ваш взгляд, является загаданным компьютером: ";
			cin >> enterNumber;
		...
		case 2:
			...
			cout << "1) Это число делиться на\n";
			cout << "2) Это число больше числа\n";
			cout << "3) Это число меньше числа\n";
			cout << "4) Узнать диапазон\n";
			cout << "5) Узнать число второго разряда, если он есть\n";
			cin >> help;
			...
			case 1:
				...
				int number2;
				cout << "Введите число, на которое, вы думаете, делиться загаданное число: ";
				cin >> number2;
			...
			case 2:
				...
				int number3;
				cout << "Введите число и я скажу, больше ли оно задуманного! ";
				cin >> number3;
			...
			case 3:
				...
				int number4;
				cout << "Введите число и я скажу, меньше ли оно задуманного!";
				cin >> number4;
